...
[ 
  ...
  "Problem B.1: is_prefix, is_subsequence" >:: (fun _ ->
  ...
  "Problem B.3: remove_first, same_elements" >:: (fun _ ->
  ...
  "Problem B.4: any, all, repeated" >:: (fun _ ->
    ...
    let zeros x = x = 0 in
      ...
      assert_true  "any_repeated 7" (any_repeated [2;1;3;1;4;1;2;1;3;2;4;1]);
  ...
  "Part C: random inserts: ordered" >:: (fun _ ->
  ...
  "Part C: random inserts: balanced" >:: (fun _ ->
    let n_random_tests = 1000 in
      for i = 1 to n_random_tests do
        let lst = random_list 20 100 in
        (* let _ = print_int_list lst in *)
